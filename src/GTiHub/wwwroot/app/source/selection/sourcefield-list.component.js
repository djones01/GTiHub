...
var SourceFieldListComponent = (function () {
    ...
    SourceFieldListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.filterSubscription = this.selectService.getFilteredSourceFields().subscribe(function (sourceFields) { return _this.sourceFields = sourceFields; });
        this.selectedSubscription = this.selectService.getSelectedSourceField().subscribe(function (sourceField) { return _this.selectedSourceField = sourceField; });
    };
