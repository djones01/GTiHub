...
var RuleAddEditComponent = (function () {
    ...
    RuleAddEditComponent.prototype.ngOnInit = function () {
        ...
        this.hasSelectedTargetFieldSubscription = this.targetSelectService.hasSelectedTargetField()
            .subscribe(function (hasSelectedTargetField) { return _this.hasSelectedTargetField = hasSelectedTargetField; });
        this.getSelectedTargetFieldSubscription = this.targetSelectService.getSelectedTargetField()
            .subscribe(function (selectedTargetField) { return _this.selectedTargetField = selectedTargetField; });
    };
